# Generated by Django 5.1.1 on 2024-11-24 03:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marketplace_rut', models.CharField(blank=True, help_text='Rut asociado al Marketplace sin puntos ni dígito verificador. RUT pruebas = 96756430', max_length=15, null=True, verbose_name='Marketplace RUT')),
                ('seller_rut', models.CharField(blank=True, help_text='Rut asociado al Vendedor sin puntos ni dígito verificador. RUT pruebas = 96756430', max_length=15, null=True, verbose_name='Seller RUT')),
